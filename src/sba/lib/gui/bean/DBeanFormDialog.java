 ...
 */
public abstract class DBeanFormDialog extends JDialog implements DGuiForm {
    ...
    protected DGuiFormOwner miFormOwner;

    /** Creates new form DBeanFormDialog */
    public DBeanFormDialog() {
    ...
    public void setFormOwner(DGuiFormOwner owner) {
        miFormOwner = owner;
    }
    ...
    public int getFormStatus() {
        return DGuiConsts.FORM_STATUS_EDIT;
    }
            ...
            if (DGuiUtils.computeValidation(miClient, validateForm())) {
                ...
                if (miFormOwner != null) {
                    try {
                        ...
                        if (registry != null) {
                            if (registry.getFormAction() == DGuiConsts.FORM_ACTION_NEW) {
