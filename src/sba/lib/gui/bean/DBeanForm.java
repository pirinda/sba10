 ...
 */
public abstract class DBeanForm extends JDialog implements DGuiForm {
    ...
    protected Vector<DGridPaneForm> mvFormGrids;
    ...
    private void initComponents() {
        ...
        jbReadInfo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sba/lib/img/cmd_form_help.gif"))); // NOI18N
    ...
    protected void initComponentsBean() {
        miClient = null;
        mnBeanFormType = DLibConsts.UNDEFINED;
        mnFormType = DLibConsts.UNDEFINED;
        mnFormSubtype = DLibConsts.UNDEFINED;
        mnFormStatus = DLibConsts.UNDEFINED;
        mnFormResult = DLibConsts.UNDEFINED;
        mbFirstActivation = false;
        mbCanShowForm = true;
        msReadInfo = "";
        msCanShowFormMessage = "";
        mvFormGrids = new Vector<DGridPaneForm>();
    ...
    protected void windowClosed() {
        for (DGridPaneForm grid : mvFormGrids) {
            grid.paneViewClosed();
        }
    }
    ...
    public void setFormEditable(final boolean editable) {
        if (editable) {
            ...
            mnFormStatus = DGuiConsts.FORM_STATUS_READ;
    ...
    public abstract void setRegistry(final DDbRegistry registry) throws Exception;
    public abstract DDbRegistry getRegistry() throws Exception;
    public abstract DGuiValidation validateForm();
            ...
            if (DGuiUtils.computeValidation(miClient, validateForm())) {
                ...
                try {
                    ...
                    if (registry.canSave(miClient.getSession())) {
                        ...
                        miClient.showMsgBoxWarning(DDbConsts.MSG_REG_DENIED_UPDATE + (registry.getQueryResult().length() == 0 ? "" : "\n" + registry.getQueryResult()));
                    }
                }
