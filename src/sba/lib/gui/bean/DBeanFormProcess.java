...
import sba.lib.gui.DGuiFormProcess;
 ...
 */
public abstract class DBeanFormProcess extends JDialog implements DGuiFormProcess {
    ...
    public void addFormGrids(DGridPaneForm[] grids) {
        if (grids != null) {
            for (DGridPaneForm grid : grids) {
