 ...
 */
public class DBeanFieldDate extends JPanel implements DGuiFieldDate {
    ...
    /** Creates new form DBeanFieldDate */
    public DBeanFieldDate() {
        initComponents();
    ...
    private void jbDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDateActionPerformed
        DGuiUtils.pickDate(miClient.getDatePicker(), parseDate(), this);
    ...
    private void initComponentsCustom() {
        ...
        jftDate.setToolTipText(DGuiConsts.MSG_GUI_TTT_PICK_DATE);
    ...
    private void resetGuiType() {
        mnGuiType = DGuiConsts.GUI_TYPE_DATE;
    ...
    private void defineMaskFormatter(String pattern) {
        try {
            jftDate.setFormatterFactory(new DefaultFormatterFactory(new MaskFormatter(DGuiUtils.createMaskFormatterDatetime(pattern))));
        }
