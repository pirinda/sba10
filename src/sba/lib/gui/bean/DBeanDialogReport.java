 ...
 */
public abstract class DBeanDialogReport extends JDialog {
    ...
    protected DGuiParams moParams;
    protected HashMap<String, Object> moParamsMap;

    /** Creates new form DBeanDialogReport */
    public DBeanDialogReport() {
    ...
    protected void initComponentsBean() {
        ...
        DGuiUtils.createActionMap(rootPane, this, "actionClose", "close", KeyEvent.VK_ESCAPE);
    }
