 ...
 */
public class DBeanCompoundField extends JPanel implements DGuiCompoundField {

    protected DGuiClient miClient;

    /** Creates new form DBeanCompoundField */
    public DBeanCompoundField() {
        initComponents();
    ...
    private void initComponents() {
        ...
        moDecValue = new sba.lib.gui.bean.DBeanFieldDecimal();
    ...
    private sba.lib.gui.bean.DBeanFieldDecimal moDecValue;
    ...
    public void setCompoundText(String text) {
        jtfText.setText(DLibUtils.textTrim(text));
