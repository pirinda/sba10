 ...
 */
public class DBeanFieldCalendarMonth extends JSpinner implements DGuiFieldCalendar {
    ...
    public DBeanFieldCalendarMonth() {
        msFieldName = "";
        mnDefaultValue = 1;
        mnMinInteger = 1;
        mnMaxInteger = 12;
        ...
        setEditor(new JSpinner.NumberEditor(this, DLibUtils.DecimalFormatCalendarMonth.toPattern()));
    ...
    public int getGuiType() {
        return DGuiConsts.GUI_TYPE_INT_CAL_MONTH;
    }
