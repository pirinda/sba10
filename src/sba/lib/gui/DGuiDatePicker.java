 ...
 */
public class DGuiDatePicker extends JDialog implements DGuiOptionPicker, ActionListener {
    ...
    private DGuiDate moGuiDate;

    /**
     * Creates new form SGuiDatePicker
     *
     * @param client Client interface.
     * @param formType Constants defined in erp.lib.DLibConsts.
     */
    public DGuiDatePicker(DGuiClient client, int pickerType) {
    ...
    private void initComponentsCustom() {
        String[] days = DLibTimeUtils.createDaysOfWeekStd(Calendar.SHORT);
        masMonths = DLibTimeUtils.createMonthsOfYear(Locale.getDefault(), Calendar.LONG);
        ...
        if (mnPickerType == DGuiConsts.DATE_PICKER_DATE) {
            jbSelectedMonth.setEnabled(false);
            jbSelectedYear.setEnabled(false);
        }

        DGuiUtils.createActionMap(rootPane, this, "actionPrevMonth", "prevMonth", KeyEvent.VK_PAGE_UP, 0);
        DGuiUtils.createActionMap(rootPane, this, "actionPrevYear", "prevYear", KeyEvent.VK_PAGE_UP, KeyEvent.CTRL_DOWN_MASK);
        DGuiUtils.createActionMap(rootPane, this, "actionNextMonth", "nextMonth", KeyEvent.VK_PAGE_DOWN, 0);
        DGuiUtils.createActionMap(rootPane, this, "actionNextYear", "nextYear", KeyEvent.VK_PAGE_DOWN, KeyEvent.CTRL_DOWN_MASK);
        DGuiUtils.createActionMap(rootPane, this, "actionSystemDate", "systemDate", KeyEvent.VK_S, KeyEvent.CTRL_DOWN_MASK);
        DGuiUtils.createActionMap(rootPane, this, "actionWorkingDate", "workingDate", KeyEvent.VK_T, KeyEvent.CTRL_DOWN_MASK);
        DGuiUtils.createActionMap(rootPane, this, "actionSelectedDate", "selectedDate", KeyEvent.VK_D, KeyEvent.CTRL_DOWN_MASK);
        DGuiUtils.createActionMap(rootPane, this, "actionSelectedMonth", "selectedMonth", KeyEvent.VK_M, KeyEvent.CTRL_DOWN_MASK);
        DGuiUtils.createActionMap(rootPane, this, "actionSelectedYear", "selectedYear", KeyEvent.VK_A, KeyEvent.CTRL_DOWN_MASK);
    ...
    private void renderCalendar() {
        ...
        colOfFirstDay = gc.get(Calendar.DAY_OF_WEEK) - (DLibTimeUtils.getFirstDayOfWeekStd() - 1) - 1;
        if (colOfFirstDay < 0) {
        ...
        gc.setTime(moGuiDate);
        day = 0;
        dayMax = DLibTimeUtils.getMaxDayOfMonth(moGuiDate);
    ...
    private void actionRenderCalendar(int incYear, int incMonth) {
        ...
        moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_DATE, gc.getTime().getTime());
        renderCalendar();
    }
    ...
    public void actionSystemDate() {
        moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_DATE, miClient.getSession().getSystemDate().getTime());
        mnPickerResult = DGuiConsts.FORM_RESULT_OK;
        setVisible(false);
    }

    public void actionWorkingDate() {
        moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_DATE, miClient.getSession().getWorkingDate().getTime());
        mnPickerResult = DGuiConsts.FORM_RESULT_OK;
        setVisible(false);
    }

    public void actionSelectedDate() {
        DGuiValidation validation = validatePicker();
        ...
        if (!validation.isValid()) {
            ...
            moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_DATE, catchSelectedDate().getTime().getTime());
            mnPickerResult = DGuiConsts.FORM_RESULT_OK;
            setVisible(false);
        }
    }
    ...
    public void actionSelectedMonth() {
        if (jbSelectedMonth.isEnabled()) {
            moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_MONTH, catchSelectedDate().getTime().getTime());
            mnPickerResult = DGuiConsts.FORM_RESULT_OK;
            setVisible(false);
        }
    }
    ...
    public void actionSelectedYear() {
        if (jbSelectedYear.isEnabled()) {
            moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_YEAR, catchSelectedDate().getTime().getTime());
            mnPickerResult = DGuiConsts.FORM_RESULT_OK;
            setVisible(false);
        }
    }
    ...
    public void resetPicker() {
        ...
        moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_DATE, miClient.getSession().getWorkingDate().getTime());
        jtfSystemDate.setText(DLibUtils.DateFormatDate.format(miClient.getSession().getSystemDate()));
        jtfWorkingDate.setText(DLibUtils.DateFormatDate.format(miClient.getSession().getWorkingDate()));
    }
    ...
    public void setOption(final Object option) {
        if (option == null) {
            ...
            moGuiDate = new DGuiDate(DGuiConsts.GUI_DATE_DATE, ((Date) option).getTime());
        }

        jtfDate.setText(DLibUtils.DateFormatDate.format(moGuiDate));
        renderCalendar();
    }

    @Override
    public DGuiDate getOption() {
        return moGuiDate;
    }
