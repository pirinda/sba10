...
public class DGuiDateRangePicker extends JDialog implements DGuiOptionPicker, ActionListener {
    ...
    public DGuiDateRangePicker(DGuiClient client) {
        super(client.getFrame(), true);
        miClient = client;
        mnPickerType = DGuiConsts.DATE_PICKER_DATE_RANGE;
        initComponents();
    ...
    private void initComponentsCustom() {
        String[] months = DLibTimeUtils.createMonthsOfYear(Locale.getDefault(), Calendar.SHORT);
    ...
    private void actionYear() {
        moDateStart.setValue(DLibTimeUtils.createDate((Integer) moCalYear.getValue(), 1, 1));
        moDateEnd.setValue(DLibTimeUtils.createDate((Integer) moCalYear.getValue(), 12, 31));

        actionOk();
    }

    private void actionMonth(int month) {
        moDateStart.setValue(DLibTimeUtils.createDate((Integer) moCalYear.getValue(), month, 1));
        moDateEnd.setValue(DLibTimeUtils.createDate((Integer) moCalYear.getValue(), month, DLibTimeUtils.getMaxDayOfMonth(moDateStart.getValue())));
    ...
    public void resetPicker() {
        ...
        moDateStart.setValue(DLibTimeUtils.getBeginOfMonth(miClient.getSession().getWorkingDate()));
        moDateEnd.setValue(DLibTimeUtils.getEndOfMonth(miClient.getSession().getWorkingDate()));
        moCalYear.setValue(DLibTimeUtils.digestYear(miClient.getSession().getWorkingDate())[0]);
    }
