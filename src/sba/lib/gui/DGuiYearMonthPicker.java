 ...
 */
public class DGuiYearMonthPicker extends JDialog implements DGuiOptionPicker, ActionListener {
    ...
    /** Creates new form DGuiYearMonthPicker */
    public DGuiYearMonthPicker(DGuiClient client) {
        super(client.getFrame(), true);
        miClient = client;
        mnPickerType = DGuiConsts.DATE_PICKER_YEAR_MONTH;
        initComponents();
    ...
    private void initComponents() {
        ...
        moCalMonth = new sba.lib.gui.bean.DBeanFieldCalendarMonth();
    ...
    private sba.lib.gui.bean.DBeanFieldCalendarMonth moCalMonth;
    ...
    public void resetPicker() {
        int[] period = DLibTimeUtils.digestMonth(miClient.getSession().getWorkingDate());
