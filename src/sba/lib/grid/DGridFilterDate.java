 ...
 */
public class DGridFilterDate extends JPanel implements DGridFilter {
    ...
    public DGridFilterDate(DGuiClient client, DGridPaneView paneView) {
        miClient = client;
        moPaneView = paneView;
        initComponents();
    ...
    private void jbDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDateActionPerformed
        ...
        if (moDatePicker.getPickerResult() == DGuiConsts.FORM_RESULT_OK) {
            setDate(new DGuiDate(DGuiConsts.GUI_DATE_DATE, moDatePicker.getOption().getTime()));
