 ...
 */
public class DUtilPasswordDlg extends javax.swing.JDialog {
    ...
    public void actionOk() {
        ...
        if (passwordOld.length() == 0) {
            miClient.showMsgBoxWarning(DGuiConsts.ERR_MSG_FIELD_REQ + "'" + DGuiUtils.getLabelName(jlPasswordOld.getText()) + "'.");
            jpfPasswordOld.requestFocus();
        }
        else if (passwordNew.length() == 0) {
            miClient.showMsgBoxWarning(DGuiConsts.ERR_MSG_FIELD_REQ + "'" + DGuiUtils.getLabelName(jlPasswordNew.getText()) + "'.");
            jpfPasswordNew.requestFocus();
        }
        else if (passwordConfirm.length() == 0) {
            miClient.showMsgBoxWarning(DGuiConsts.ERR_MSG_FIELD_REQ + "'" + DGuiUtils.getLabelName(jlPasswordConfirm.getText()) + "'.");
            jpfPasswordConfirm.requestFocus();
        }
        else if (passwordNew.compareTo(passwordConfirm) != 0) {
            miClient.showMsgBoxWarning(DGuiConsts.ERR_MSG_FIELD_REQ_EQUAL + "'" + DGuiUtils.getLabelName(jlPasswordNew.getText()) + "', '" + DGuiUtils.getLabelName(jlPasswordConfirm.getText()) + "'.");
            jpfPasswordOld.requestFocus();
            resetPasswords();
        }
        else {
